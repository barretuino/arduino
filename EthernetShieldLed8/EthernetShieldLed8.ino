    ...
    while (client.connected())
    {
      if (client.available())
      {
        ...
        if (c == '\n' && currentLineIsBlank)
        {
          ...
          if(rele5 == 1)
          {
            client.println("<br><LI><font color=’blue’ size=’5′><a href=http://192.168.2.99/5off/><font color=red><i>Desligar Saida 5</i></font></a>");
            digitalWrite(pin_rly5, HIGH);
          }
          else if (rele5 ==0)
          {
            client.println("<br><LI><font color=’blue’ size=’5′><a href=http://192.168.2.99/5on/>LIGAR SAIDA 5</a>");
            digitalWrite(pin_rly5, LOW);
          }
          if(rele6 == 1)
          {
            client.println("<br><LI><font color=’blue’ size=’5′><a href=http://192.168.2.99/6off/><font color=red><i>Desligar Saida 6</i></font></a>");
            digitalWrite(pin_rly6, HIGH);
          }
          else if (rele6 ==0)
          {
            client.println("<br><LI><font color=’blue’ size=’5′><a href=http://192.168.2.99/6on/>LIGAR SAIDA 6</a>");
            digitalWrite(pin_rly6, LOW);
          }
          if(rele7 == 1)
          {
            client.println("<br><LI><font color=’blue’ size=’5′><a href=http://192.168.2.99/7off/><font color=red><i>Desligar Saida 7</i></font></a>");
            digitalWrite(pin_rly7, HIGH);
          }
          else if (rele7 ==0)
          {
            client.println("<br><LI><font color=’blue’ size=’5′><a href=http://192.168.2.99/7on/>LIGAR SAIDA 7</a>");
            digitalWrite(pin_rly7, LOW);
          }
          if(rele8 == 1)
          {
            client.println("<br><LI><font color=’blue’ size=’5′><a href=http://192.168.2.99/8off/><font color=red><i>Desligar Saida 8</i></font></a>");
            digitalWrite(pin_rly8, HIGH);
          }
          else if (rele8 ==0)
          {
            client.println("<br><LI><font color=’blue’ size=’5′><a href=http://192.168.2.99/8on/>LIGAR SAIDA 8</a>");
            digitalWrite(pin_rly8, LOW);
          }
          client.println("</UL>");
